...
import { AlertCircle, AlertTriangle, Info, RefreshCw, Trash2 } from 'lucide-react-native';
...
function createStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    ownerCard: { backgroundColor: c.bgCard, borderRadius: 10, padding: 12, marginBottom: 8 },
    ownerRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 4 },
    ownerLabel: { fontSize: 12, color: c.textSecondary, fontWeight: '600' as const },
    ownerValue: { fontSize: 12, color: c.text, maxWidth: '60%' },
