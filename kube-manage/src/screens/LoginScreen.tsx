...
import { Lock, Mail, Ship } from 'lucide-react-native';
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          <View style={styles.sectionHeader}>
            <View style={styles.iconContainer}>
              <Ship size={28} color={colors.accent} />
            </View>
            <Text style={styles.title}>KubePilot</Text>
            <Text style={styles.subtitle}>Sign in to manage your clusters</Text>
          </View>
          ...
          >
            <Text style={styles.primaryBtnText}>{isAuthenticating ? 'Signing In...' : 'Log In'}</Text>
          </TouchableOpacity>
