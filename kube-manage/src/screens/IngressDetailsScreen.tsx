      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          <View style={styles.headerIcon}>
            <Globe size={24} color={colors.accentPink} />
          </View>
              ...
              return (
                <View key={ri} style={styles.ruleCard}>
                  <View style={styles.ruleHostRow}>
                    <Globe size={14} color={colors.accentPink} />
...
function createStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    cyan: { color: c.accent },
    ruleCard: { backgroundColor: c.bgCard, borderRadius: 10, padding: 12, marginBottom: 10, borderWidth: 1, borderColor: c.border },
    ...
    pathsContainer: { borderRadius: 8, overflow: 'hidden', borderWidth: 1, borderColor: c.border },
    pathHeader: { flexDirection: 'row', backgroundColor: c.border, paddingHorizontal: 10, paddingVertical: 8 },
    pathHeaderText: { fontSize: 11, fontWeight: '700' as const, color: c.textSecondary, textTransform: 'uppercase' },
    pathRow: { flexDirection: 'row', paddingHorizontal: 10, paddingVertical: 8, alignItems: 'center' },
    pathRowEven: { backgroundColor: c.bgSecondary },
    pathCellLeft: { flex: 2, flexDirection: 'row', alignItems: 'center', gap: 6 },
    pathCell: { fontSize: 12, color: c.text },
    noPathsText: { fontSize: 12, color: c.textSecondary, fontStyle: 'italic' },
    tlsCard: { backgroundColor: c.bgCard, borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: '#00D9FF30' },
    tlsHeaderRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 },
    tlsSecretLabel: { fontSize: 13, color: c.textSecondary, fontWeight: '600' as const },
