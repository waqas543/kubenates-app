...
const styles = StyleSheet.create({
  ...
  tableCard: { backgroundColor: '#162033', borderRadius: 10, overflow: 'hidden', borderWidth: 1, borderColor: '#1E2B42' },
  tableHeader: { flexDirection: 'row', backgroundColor: '#1E2B42', paddingHorizontal: 12, paddingVertical: 10 },
  tableHeaderCell: { fontSize: 11, fontWeight: '700' as const, color: '#8B92A8', textTransform: 'uppercase' },
  tableRow: { flexDirection: 'row', paddingHorizontal: 12, paddingVertical: 10 },
  tableRowEven: { backgroundColor: '#0D1219' },
  tableCell: { fontSize: 13, color: '#FFFFFF' },
