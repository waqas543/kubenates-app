...
import { AlertCircle, AlertTriangle, Clock, Info, Pause, Play, Trash2 } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          <View style={styles.headerIcon}><Clock size={24} color={colors.accentPurple} /></View>
